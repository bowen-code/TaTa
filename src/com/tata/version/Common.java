...
public class Common {
	...
	public static final String SERVER_ADDRESS=SERVER_IP+"data/updateVersion.php";//软件更新包地址
	public static final String UPDATESOFTADDRESS=SERVER_IP+"update_package/";//软件更新包地址
