...
public class GraduateActivity extends BaseActivity implements OnItemClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setTopText("毕业游");
		View view = getLayoutInflater().inflate(R.layout.activity_graduate, null);
		setCenterView(view);
		initOption();
...
//		viewPager.setAdapter(new GuideAdapter(advPics));
	...
	private void init(View view) {
		...
		start.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(GraduateActivity.this, SearchActivity.class);
		...
		httpClient.get("http://120.24.254.127/tata/data/getGraduateImg.php",new TextHttpResponseHandler() {
		...
		if (NetWorkHelper.checkNetState(this)) {
			...
			client.post(url, params, new TextHttpResponseHandler() {
				...
				public void onSuccess(int arg0, Header[] arg1, String arg2) {
					...
					adapter = new MyAdapter(list, GraduateActivity.this);
					gridView.setAdapter(adapter);
					gridView.setOnItemClickListener(GraduateActivity.this);
					ACache mCache = ACache.get(GraduateActivity.this);
	...
	public void onFooterRefresh(PullToRefreshView view) {
		...
		client.post(url, params, new TextHttpResponseHandler() {
			...
			public void onFailure(int arg0, Header[] arg1, String arg2,
					Throwable arg3) { 
				mPullToRefreshView.onFooterRefreshComplete();// TODO Auto-generated method stub
			}
			...
			public void onSuccess(int arg0, Header[] arg1, String arg2) { // TODO
				...
				if (addlist.size() != 0){
					gridView.setTranscriptMode(AbsListView.TRANSCRIPT_MODE_ALWAYS_SCROLL);
