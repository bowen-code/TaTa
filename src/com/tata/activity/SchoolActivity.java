...
public class SchoolActivity extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.bt_right:
			...
			dialog.show();
			final String schoolString=school.getText().toString().trim();
			if(!schoolString.equals("")){
				 ...
				 dialog.dismiss();
				 Toast.makeText(SchoolActivity.this,"修改成功",
				 ...
				 System.out.println(arg2);
				 dialog.dismiss();
				 Toast.makeText(SchoolActivity.this,"修改失败",
				 Toast.LENGTH_SHORT).show();
				 }
